...
df = pd.read_csv('C:/dark-patterns-recognition-master/train_classifier/dark_patterns.csv')
...
dump(clf, 'C:/dark-patterns-recognition-master/api/category_classifier.joblib')
dump(count_vect, 'C:/dark-patterns-recognition-master/api/category_vectorizer.joblib')
