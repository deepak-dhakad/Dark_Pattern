...
df1 = pd.read_csv('C:/dark-patterns-recognition-master/normie.csv', encoding='latin1')

df2 = pd.read_csv('C:/dark-patterns-recognition-master/train_classifier/dark_patterns.csv')
